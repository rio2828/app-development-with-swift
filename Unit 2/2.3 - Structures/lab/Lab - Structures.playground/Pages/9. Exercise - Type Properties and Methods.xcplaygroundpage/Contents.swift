...
let me = User(userName: "Harry", email: "harry@hogwart.ac.kr", age: 16)
let friend = User(userName: "Jabberwork", email: "jabber@wonderland.com", age: 300)
