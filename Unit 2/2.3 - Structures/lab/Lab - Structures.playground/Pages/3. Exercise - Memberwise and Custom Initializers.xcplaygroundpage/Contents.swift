 ...
 */
struct Book {
    var title: String = "Unacceptable"
    var author: String = "Blizzard"
    var pages: Int = 300
    var price: Double = 10.00
}

var book: Book = Book(title: "Wuthering heights", author: "Emily Bronte", pages: 320)
print(book.self)
/*:
...
struct Height {
    ...
    init(inchesInput: Double) {
        self.heightInCentimeters = 2.54 * inchesInput
        self.heightInInches = inchesInput
    }
    
    init(centimetersInput: Double) {
        self.heightInInches = centimetersInput / 2.54
        self.heightInCentimeters = centimetersInput
    }
}
 ...
 */
var someonesHeight: Height = Height(inchesInput: 65)
 ...
 */
var myHeight: Height = Height(centimetersInput: 177.7)
