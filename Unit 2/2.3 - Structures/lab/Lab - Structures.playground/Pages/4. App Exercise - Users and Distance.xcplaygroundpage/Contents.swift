 ...
 */
var taeHyun: User = User(userName: "김태현", userAge: 27, userHeight: 177.7, userWeight: 75.6, userActivityLevel: 5)
...
struct Distance {
    var meters: Double
    var feet : Double
    init(meterToFeet: Double) {
        self.meters = meterToFeet
        self.feet = 3.28084 * meterToFeet
    }
    init(feetToMeter: Double) {
        self.meters = feetToMeter / 3.28084
        self.feet = feetToMeter
    }
}
 ...
 */
var mile: Distance = Distance(meterToFeet: 1600)
print(mile.feet)

/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var homecoming: Distance = Distance(meterToFeet: 3210)
print(homecoming.feet)
