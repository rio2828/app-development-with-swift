 ...
 */
var walkingChallenges: Array<String> = ["Walk 3 miles a day", "Walk 30 minutes or more"]
var runningChallenges: Array<String> = ["Run 1 miles a day", "Run 10 mintues or more"]
 ...
 */
var challengesCommited: Array<String> = ["Walk the moon"]
