...
calculateArea(width: 8, height: 9)
calculateArea(width: -1, height: 8)
/*:
...
func add(num1: Int?, num2: Int?) -> Int? {
    guard let x = num1, let y = num2 else { return nil }
    return x + y
}
add(num1: 8, num2: nil)
/*:
 ...
 */
if let x = createUser()?.age {
    print(x)
}
if let x = createUser()?.firstName {
    print(x)
}
if let x = createUser()?.lastName {
    print(x)
}
